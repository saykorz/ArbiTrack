...
namespace ArbiTrack.Data
{
    public class UowData : IUowData
    {
        ...
        public IRepository<ImpossibleFutureAppModel> ImpossibleFutureApps => GetRepository<ImpossibleFutureAppModel>(); 
        public IRepository<LogModel> Logs => GetRepository<LogModel>();
